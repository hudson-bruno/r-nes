...
pub trait Stack {
    fn stack_push(&mut self, mem: &mut impl CpuMemory, value: u8);
    fn stack_pop(&mut self, mem: &mut impl CpuMemory) -> u8;

    fn stack_push_address(&mut self, mem: &mut impl CpuMemory, addr: u16) {
    ...
    fn stack_pop_address(&mut self, mem: &mut impl CpuMemory) -> u16 {
