...
pub trait Instructions {
    ...
    fn ora(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn asl(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn php(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn bpl(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn clc(&mut self) -> Option<ExitStatus>;
    fn jsr(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn and(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn bit(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    ...
    fn eor(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    ...
    fn bcc(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn tya(&mut self) -> Option<ExitStatus>;
    fn txs(&mut self) -> Option<ExitStatus>;
    fn ldy(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn lda(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn ldx(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn tay(&mut self) -> Option<ExitStatus>;
    fn tax(&mut self) -> Option<ExitStatus>;
    fn bcs(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn clv(&mut self) -> Option<ExitStatus>;
    fn tsx(&mut self) -> Option<ExitStatus>;
    fn cpy(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn cmp(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn dec(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn iny(&mut self) -> Option<ExitStatus>;
    fn dex(&mut self) -> Option<ExitStatus>;
    fn bne(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn cld(&mut self) -> Option<ExitStatus>;
    fn cpx(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn sbc(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn inc(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
    fn inx(&mut self) -> Option<ExitStatus>;
    fn nop(&mut self) -> Option<ExitStatus>;
    fn beq(&mut self, mem: &mut impl Memory) -> Option<ExitStatus>;
