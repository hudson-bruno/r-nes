use crate::cpu::{Cpu, memory::CpuMemory, operand::OperandLocation};
...
pub trait AddressingModes {
    ...
    fn zero_page(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn zero_page_x(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn zero_page_y(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn relative(&mut self) -> OperandLocation;
    fn absolute(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn absolute_x(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn absolute_y(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn indirect(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn indirect_x(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
    fn indirect_y(&mut self, mem: &mut impl CpuMemory) -> OperandLocation;
}
